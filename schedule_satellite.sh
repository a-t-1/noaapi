...
OUTDATE=`date --date="TZ=\"UTC\" $START_TIME" +%Y%m%d_%H%M%S`

if [ $MAXELEV -gt 19 ]
  then
    echo ${1} ${OUTDATE} $MAXELEV >> /home/pi/weather/predict/upcoming
...
#    echo "/home/pi/weather/predict/receive_and_process_satellite.sh \"${1}\" $2 /home/pi/weather/${1//" "}${OUTDATE} /home/pi/weather/predict/weather.tle $var1 $TIMER" | at `date --date="TZ=\"UTC\" $START_TIME" +"%H:%M %D"`
    echo "/home/pi/weather/predict/receive_and_process_satellite.sh \"${1}\" $2 /home/pi/weather/${OUTDATE}_${1//" "} /home/pi/weather/predict/weather.tle $var1 $TIMER"
    echo "/home/pi/weather/predict/receive_and_process_satellite.sh \"${1}\" $2 /home/pi/weather/${OUTDATE}_${1//" "} /home/pi/weather/predict/weather.tle $var1 $TIMER" | at `date --date="TZ=\"UTC\" $START_TIME" +"%H:%M %D"`
